...
>
	...
	<!-- Labels -->
	<div
		class="absolute bottom-3 left-3 text-xs font-medium tracking-wide text-white uppercase"
	>
		{leftLabel}
	</div>
	<div
		class="absolute right-3 bottom-3 text-xs font-medium tracking-wide text-white uppercase"
	>
		{rightLabel}
	</div>
</div>
